...
По точным inbound-строкам `agent.log` в окне сбоя отсутствовали последующие
успешные tool calls. После восстановления мама повторно отправила расход
`Укув куролларига 210 минг`; в 18:41 бот ответил: «Ойижон, ўқув қуролларига
210 000 сўмни ёзиб қўйдим». Эта позиция восстановлена. Заказчику осталось
дозанести:
