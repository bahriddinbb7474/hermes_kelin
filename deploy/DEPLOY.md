...
- Текущий VPS runtime до v3.18 fix deploy: tools/dispatch/MCP discovery **21/21/21**, plugin **1.0.4**, migration 003 active, deployed SOUL SHA `5f7b08569cfd75cd26d78a234fbb8a39322dfc65e9221ae2d461e89444148266`; Stage 5.1 и Stage 5.2 — **CLOSED / LIVE PASS**, Stage 5.3 — **OFFLINE PASS / LIVE PENDING**.
...
существующих budget tools реализованы, inventory остаётся **21/21/21**. v3.18
добавляет optional read-only `price_lookup_items` в существующий status tool и
profile-only запрет `terminal`/`code_execution`. Единственный canonical repo-source —
