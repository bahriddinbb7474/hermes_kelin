...
*Статус (2026-07-12): offline-тест языка пройден — 24/24 ответа без латиницы на выбранной LLM (skill установлен, sha256==repo). Живой Telegram AC (20 фраз через бота) — впереди, после gateway.*
