...
Исполнять только `TZ_Hermes_Mariyam_FINAL_v3_0.md` (внутри — версия **3.12**, раздел 0.1–0.12 = changelog): §0.9 — Stage 5.1 CLOSED / LIVE PASS; §0.10 — planned household finance; §0.11 — Stage 5.2 offline implementation; §0.12 — Stage 5.2 live FAIL и reference prices. Старые v1/v2/review-файлы не использовать как рабочие требования.
