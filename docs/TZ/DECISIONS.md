...
- **Голосовые ответы отключены (TTS off):** решение заказчика. Мариям отвечает Ойижон **только текстом** (узбекская кириллица). Голосовой *ввод* (voice message) остаётся — принимается и транскрибируется Whisper как обычно. TTS включим позже, только когда выберем приличный узбекский женский/мягкий голос.
