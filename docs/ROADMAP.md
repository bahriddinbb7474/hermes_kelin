...
| 6 | Hermes cron: reminders, recurring obligations, утро/вечер, новости, погода, намаз | 🟡 **PARTIAL — шаг 2 repo ready, live pending:** recurring obligations + 3 read-only external tools, inventory **29/29/29**; daily cache/stale fallback; согласовано UzA + Kun.uz, 08:30/19:30; canonical read-only cron prompts и safe untrusted one-shot готовы. До CLOSED нужны controlled VPS deploy, штатный tick и Telegram evidence; OpenWeather key должен быть добавлен только в private secrets. |
