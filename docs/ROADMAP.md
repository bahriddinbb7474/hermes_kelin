...
| 2 | Profile prompt Мариям: стиль, язык, onboarding, кириллица | 🟡 runtime использует Stage 5.1 skill; canonical prompt v3.14 перенесён в SOUL и проверен offline, но ещё не развёрнут; **PARTIAL живой AC: 8/20 фраз проверены (8/8 кириллица, LATIN_LINES=[]), полный AC НЕ пройден — тест остановлен заказчиком, не из-за FAIL** (см. EVIDENCE_STAGE_2_PARTIAL_2026-07-12.md) |
...
| 5.2 | Простые family reports для Ойижон: общий отчёт и фактические product details по просьбе | 🟡 **OFFLINE PASS / LIVE PENDING (v3.14)**; canonical SOUL и assembled-prompt contract PASS; VPS deploy, `/new` и повторный Telegram E2E впереди |
...
- **Этап 5.2** — **OFFLINE PASS / LIVE PENDING** (v3.14): repo SOUL SHA `713021c2cfd6c3abff206b6a79ec7423c06c6920645ce4a6c2d31158a108c98a`; VPS после rollback использует legacy SKILL SHA `b12311829a35e8faa9f97872b52a9edbb2b68f499b8c757b7204686e447147e4`; deploy и повторный Telegram E2E ещё не выполнялись.
- **Stages 5.3–6 planned only (v3.14):** migrations 003/004/005, price snapshot, utility connector, approval/obligation tools и cron jobs не реализованы; tool count 27 не является runtime.
