...
| 2 | Profile prompt Мариям: стиль, язык, onboarding, кириллица | 🟡 runtime использует Stage 5.1 skill; canonical prompt v3.15 в SOUL проверен offline, но narrow fix ещё не развёрнут; **PARTIAL живой AC: 8/20 фраз проверены (8/8 кириллица, LATIN_LINES=[]), полный AC НЕ пройден — тест остановлен заказчиком, не из-за FAIL** (см. EVIDENCE_STAGE_2_PARTIAL_2026-07-12.md) |
...
| 5.2 | Простые family reports для Ойижон: общий отчёт и фактические product details по просьбе | 🟡 **OFFLINE PASS / LIVE PENDING (v3.15)**; Message 1 live PASS, Message 2 format-only FAIL, rollback PASS; narrow category-table fix offline PASS, deploy/retest впереди |
...
- **Этап 5.2** — **OFFLINE PASS / LIVE PENDING** (v3.15): repo LF SOUL SHA `a9b584e14d704f08b4778b7928ca71a0cf095394583f769c5e9571097884b4e4`; previous live Message 1 PASS / Message 2 format-only FAIL / rollback PASS; VPS использует legacy SKILL SHA `b12311829a35e8faa9f97872b52a9edbb2b68f499b8c757b7204686e447147e4`; narrow fix ещё не развёрнут.
- **Stages 5.3–6 planned only (v3.15):** migrations 003/004/005, price snapshot, utility connector, approval/obligation tools и cron jobs не реализованы; tool count 27 не является runtime.
