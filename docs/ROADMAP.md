...
| 5.3A | Approval cycle 25/27/28/1, `approve_monthly_plan`, deterministic cron identity | 🟡 **PARTIAL / CONTROLLED DEPLOY PASS**: identity plugin **1.1.0** deployed, cron resolver прошёл offline/live fail-closed probes и Telegram regression; production mapping/jobs, approval tool и cycle runtime не реализованы; cycles schema подготовлена в migration 003, planned count 22 |
