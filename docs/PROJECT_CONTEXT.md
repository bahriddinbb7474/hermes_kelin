...
ТЗ: **v3.13**. Этап 5.1 остаётся **CLOSED / LIVE PASS**. Stage 5.2 = **OFFLINE PASS / LIVE PENDING**: canonical SKILL и permanent contracts приведены к решениям заказчика, локальные проверки PASS. Repo SKILL SHA = `f00214f7ebdd280bc71b04b133a40d7e018708bf35f7facea73843ec8cc02693`; после rollback VPS/profile остаются на Stage 5.1 SHA `b12311829a35e8faa9f97872b52a9edbb2b68f499b8c757b7204686e447147e4`, plugin **1.0.4**, migration 002, inventory 21. Stage 5.3–6 — **PLANNED / NOT IMPLEMENTED**; migrations 003/004/005 отсутствуют. Deploy и повторный Telegram E2E ещё не выполнялись; реальная Ойижон не подключена.
...
- В профиль после rollback установлен Stage 5.1 skill (enabled, SHA `b12311829a35e8faa9f97872b52a9edbb2b68f499b8c757b7204686e447147e4`); Stage 5.2 repo SHA `f00214f7ebdd280bc71b04b133a40d7e018708bf35f7facea73843ec8cc02693` не является live runtime.
...
- **Stage 5.2: OFFLINE PASS / LIVE PENDING** (v3.13) — canonical SKILL/test fix и локальные проверки PASS; deploy и повторный Telegram E2E ещё не выполнялись. Предыдущий live FAIL: `EVIDENCE_STAGE_5_2_LIVE_FAIL_2026-07-15.md`.
- **Planned v3.13:** Stage 5.3 product plans + reference price snapshot; Stage 5.3A approval cycle + cron identity gate; Stage 5.4 utility read-only; Stage 6 recurring obligations. Planned tools 21→22→25→27; current runtime не менялся.
- **Skill-protect:** repo assertion = `f00214f7ebdd280bc71b04b133a40d7e018708bf35f7facea73843ec8cc02693`; VPS protection после rollback фиксирует runtime SHA `b12311829a35e8faa9f97872b52a9edbb2b68f499b8c757b7204686e447147e4`; `tool_progress` off.
