...
ТЗ: **v3.12**. Этап 5.1 остаётся **CLOSED / LIVE PASS**. Stage 5.2 = **LIVE FAIL / FIX REQUIRED**: controlled E2E подтвердил суммы, identity, кириллицу, отсутствие traces и cleanup, но обязательная финальная фраза отсутствовала. Repo SKILL SHA остаётся `b3afd9ecfb16a4d4618be898573a84c00ae24a1c3b41e8ae57823912b9ac9d18`; после rollback VPS/profile остаются на Stage 5.1 SHA `b12311829a35e8faa9f97872b52a9edbb2b68f499b8c757b7204686e447147e4`, plugin **1.0.4**, migration 002, inventory 21. Stage 5.3–6 — **PLANNED / NOT IMPLEMENTED**; migrations 003/004/005 отсутствуют. Повторный live test после будущего SKILL-fix ещё не выполнялся; реальная Ойижон не подключена.
...
- В профиль после rollback установлен Stage 5.1 skill (enabled, SHA `b12311829a35e8faa9f97872b52a9edbb2b68f499b8c757b7204686e447147e4`); Stage 5.2 repo SHA `b3afd9ecfb16a4d4618be898573a84c00ae24a1c3b41e8ae57823912b9ac9d18` не является live runtime.
...
- **Stage 5.2: LIVE FAIL / FIX REQUIRED** (v3.12) — controlled E2E выполнен; новый SKILL/test fix и повторный live test ещё не выполнялись. Evidence: `EVIDENCE_STAGE_5_2_LIVE_FAIL_2026-07-15.md`.
- **Planned v3.12:** Stage 5.3 product plans + reference price snapshot; Stage 5.3A approval cycle + cron identity gate; Stage 5.4 utility read-only; Stage 6 recurring obligations. Planned tools 21→22→25→27; current runtime не менялся.
- **Skill-protect:** repo assertion остаётся `b3afd9ecfb16a4d4618be898573a84c00ae24a1c3b41e8ae57823912b9ac9d18`; VPS protection после rollback фиксирует runtime SHA `b12311829a35e8faa9f97872b52a9edbb2b68f499b8c757b7204686e447147e4`; `tool_progress` off.
